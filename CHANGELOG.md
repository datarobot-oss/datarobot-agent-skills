...
- All SDK skills: install one-liner `uv pip install ... || python -m pip install ...` (uv first for speed and package caching; bare `pip` failed in recorded runs — no pip in uv venvs, PEP 668).
