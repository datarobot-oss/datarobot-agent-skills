...
def test_data_nested_string_leaves_pass() -> None:
    schema = {
        "type": "object",
        "properties": {
            "data": {
...
def test_data_non_string_leaf_rejected() -> None:
    schema = {
        "type": "object",
        "properties": {
...
def test_data_array_rejected() -> None:
    schema = {
        "type": "object",
        "properties": {
            "data": {
...
def test_data_top_level_string_ok() -> None:
...
def test_valid_json_body_schema_passes() -> None:
    schema = {
        "type": "object",
        "properties": {
...
def test_query_params_must_be_flat() -> None:
    schema = {
        "type": "object",
        "properties": {
            "query_params": {
...
def test_path_params_as_array_type_rejected() -> None:
...
def test_main_empty_schema_returns_1_allow_empty_returns_0() -> None:
...
def test_main_valid_schema_returns_0() -> None:
