...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python make_prediction.py <deployment_id> <data_json>", file=sys.stderr)
        print("Example: python make_prediction.py abc123 '{\"feature1\": 10, \"feature2\": 20}'", file=sys.stderr)
        sys.exit(1)
