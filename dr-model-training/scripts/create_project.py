...
def create_project(dataset_id: str, project_name: str, target_column: str = None) -> dict:
    """
    Create a new DataRobot project from a dataset.
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python create_project.py <dataset_id> <project_name> [target_column]", file=sys.stderr)
        sys.exit(1)
